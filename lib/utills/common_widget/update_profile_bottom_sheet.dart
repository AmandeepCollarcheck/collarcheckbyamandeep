...
updateProfileBottomSheet(context,{required CompanyAllDetailsData companyAllDetails,required String screenName,required  CompanyUserDetailsModel companyUserDetails, int index=0}) {

  updateProfileData(context, companyUserDetails: companyUserDetails,index: index);
