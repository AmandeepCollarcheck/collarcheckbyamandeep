...
class CompanySignup {
  ...
  factory CompanySignup.fromJson(Map<String, dynamic> json) => CompanySignup(
    status: json["status"],
    messages: json["messages"],
    data: json["data"] == null ? null : CompanySignUpData.fromJson(json["data"]),
  );
...
class CompanySignUpData {
  ...
  factory CompanySignUpData.fromJson(Map<String, dynamic> json) => CompanySignUpData(
    id: json["id"],
