...
final String strCompanyturnover = '/general/turnover';
final String strCompanySize = '/general/companysize';
final String strCompanyConnectionList = '/general/followDataList';

final String strGeneralSettings = '/user/saveSetting';
final String strgetSettings = '/user/getSetting';
final String deleteAccount = '/request-delete-account';
final String reasondeleteOptions = '/all-delete-option';
final String aigenerate = '/ai-generate';
