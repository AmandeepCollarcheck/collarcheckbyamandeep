...
import '../models/aimodel/AI_model_Data.dart';
...
class ApiProvider{
  ...
  Future aigenratedescription(FormData params) async {
    try {
      print(">>>>>>>>>>>>>>>>>>>>>>");
      print(params.fields);
      Response response = await _dio.post(aigenerate,data: params);
      Map<String, dynamic> jsonData;
      if (response.data is String) {
        jsonData = jsonDecode(response.data);
      } else {
  ...
  Future drawerCompanyconnectionListData() async {
    try {
      Response response = await _dio.get(strCompanyConnectionList);
      Map<String, dynamic> jsonData;
      if (response.data is String) {
        jsonData = jsonDecode(response.data);
      } else {
      ...
      return ConnectionListModel.fromJson(jsonData);
    }catch (error, stacktrace) {
      handleException(error, stacktrace, _dioError!);
    }
  }

  Future getSettings( {required options}) async {
    try {
      Response response = await _dio.get(strgetSettings);
      Map<String, dynamic> jsonData;
      if (response.data is String) {
        jsonData = jsonDecode(response.data);
      } else {
      ...
      return SettingsDataModel.fromJson(jsonData);
    }catch (error, stacktrace) {
      handleException(error, stacktrace, _dioError!);
    }
  }
  //account setting
  Future generalSettings(body, {required options}) async {
    ...
    try {
      ...
      Response response = await _dio.post(strGeneralSettings,data: body );
      Map<String, dynamic> jsonData;
      ...
      return SaveAccountModel.fromJson(jsonData);
    }catch (error, stacktrace) {
      handleException(error, stacktrace, _dioError!);
    }
  }
  Future deleteAccountApiCall(body, {required Options options}) async {
    try {
      Response response = await _dio.post(deleteAccount,data: body);
      Map<String, dynamic> jsonData;
      if (response.data is String) {
        jsonData = jsonDecode(response.data);
      } else {
      ...
      return DeleteAccountModel.fromJson(jsonData);
    }catch (error, stacktrace) {
      handleException(error, stacktrace, _dioError!);
    }
  }

  Future reasonDeleteAccount() async {
    try {
      Response response = await _dio.get("$reasondeleteOptions");
      Map<String, dynamic> jsonData;
      if (response.data is String) {
        jsonData = jsonDecode(response.data);
      } else {
...
//json['ReasonOptionsList']

      return DeleteAccountReasonModel.fromJson(jsonData);
    }catch (error, stacktrace) {
      handleException(error, stacktrace, _dioError!);
    }
  }

  Future getTurnOverData() async {
    try {
      Response response = await _dio.get("$strCompanyturnover" );
      Map<String, dynamic> jsonData;
      if (response.data is String) {
        jsonData = jsonDecode(response.data);
      } else {
      ...
      return TurnOverListModel.fromJson(jsonData);
    }catch (error, stacktrace) {
      handleException(error, stacktrace, _dioError!);
    }
  }

  Future getCompanySizeData() async {
    try {
      Response response = await _dio.get("$strCompanySize" );
      Map<String, dynamic> jsonData;
      if (response.data is String) {
        jsonData = jsonDecode(response.data);
      } else {
      ...
      return ComanySizeModel.fromJson(jsonData);
    }catch (error, stacktrace) {
      handleException(error, stacktrace, _dioError!);
    }
  }
  ...
  Future companyAllApplicationsBasedOnId({required String jobId}) async {
    try {
      Response response = await _dio.get('$strCompanyAllApplications?job=$jobId');
      Map<String, dynamic> jsonData;
      if (response.data is String) {
        jsonData = jsonDecode(response.data);
      } else {
  ...
  Future markAsCompleteApi({required String statusId}) async {
    try {
      Response response = await _dio.delete('$strCompanyJobStatus/$statusId');
      Map<String, dynamic> jsonData;
      if (response.data is String) {
        jsonData = jsonDecode(response.data);
      } else {
  ...
  Future companyEmploymentRequest() async {
    try {
      Response response = await _dio.get(strCompanyEmploymentRequest);
      Map<String, dynamic> jsonData;
      if (response.data is String) {
        jsonData = jsonDecode(response.data);
      } else {
      ...
      return CompanyEmploymentRequestModel.fromJson(jsonData);
    }catch (error, stacktrace) {
      handleException(error, stacktrace, _dioError!);
    }
  }
  Future companyRecommendedEmployment() async {
    try {
      Response response = await _dio.get(strCompanyEmployee);
      Map<String, dynamic> jsonData;
      if (response.data is String) {
        jsonData = jsonDecode(response.data);
      } else {
      ...
      return CompanyRecommendedEmployeeModel.fromJson(jsonData);
    }catch (error, stacktrace) {
      handleException(error, stacktrace, _dioError!);
    }
  }
  Future companyRecentlyJoinedPeople() async {
    try {
      Response response = await _dio.get(strCompanyRecentlyJoinedPeople);
      Map<String, dynamic> jsonData;
      if (response.data is String) {
        jsonData = jsonDecode(response.data);
      } else {
      ...
      return CompanyPeopleRecentlyJoinedModel.fromJson(jsonData);
    }catch (error, stacktrace) {
      handleException(error, stacktrace, _dioError!);
    }
  }
