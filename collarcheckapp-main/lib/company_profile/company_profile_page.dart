                                    ...
                                    Container(
                                      ...
                                      child: commonAppBarWithSettingAndShareOption(context,
                                        ...
                                        onSettingsClick: () {
                                          ...
                                          Get.offNamed(AppRoutes.accountsettings);
                        ...
                        children: <Widget>[
                          ...
                          GestureDetector(
                            onTap: ()async{
                              ...
                              final result=await updateProfileBottomSheet(context, companyAllDetails: controller.designationListData.value,
                                  screenName: companyProfileScreen,
                                  companyUserDetails: controller.companyUserDetails.value,
                                  turnOverModelDetails:controller.turnOverModelDetailsList.toList(),
                                  companySizeDetails:controller.companySizeModelDetailsList.toList()
