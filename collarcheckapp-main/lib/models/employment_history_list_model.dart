...
class EmploymentHistoryListModel {
  bool? status;
  String? messages;
  List<Datum>? data;

  EmploymentHistoryListModel({
    this.status,
    this.messages,
    this.data,
  });

  factory EmploymentHistoryListModel.fromJson(Map<String, dynamic> json) => EmploymentHistoryListModel(
    status: json["status"],
