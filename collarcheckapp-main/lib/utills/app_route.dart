...
import '../drawer_screens/company_connection_bindings.dart';
import '../drawer_screens/drawer_connection_screen.dart';
import '../dumy/dumy_bindings.dart';
import '../dumy/dumy_page.dart';
import '../filter/filter_bindings.dart';
import '../gernal_settings/account_settings_bindings.dart' show AccountSettingsBindings;
import '../gernal_settings/account_settings_page.dart';
...
class AppRoutes {
  ...
  static const String mycompanyconnection = '/companyconnection';
  ...
  static final routes = [
    ...
    GetPage(
      ...
      page: () => CompanyConnectionPage(),
      binding: CompanyConnectionBindings(),
    ),
    GetPage(
